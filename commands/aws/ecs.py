...
def run_task(ctx, mode, command, environment=None, extra_workers=False, is_harvester_command=False):
    """
...
def _cleanup_ecr_images(ctx, ecr_client, version_cutoff):
    ...
    images = {
        ...
        for repository in ["middleware", "middleware-nginx"]
    }
